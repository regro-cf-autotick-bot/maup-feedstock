...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/maup-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6877&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/maup-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `maup` can be installed with:

```
conda install maup
```

It is possible to list all of the versions of `maup` available on your platform with:
